...
class Req(ReqDllmMixin):
    ...
    def __init__(
        ...
        # capture router inputs, logits, and bias (delta_logits from bias_predictor)
        self.return_router_states = return_router_states
        self.router_inputs: Optional[torch.Tensor] = None
        self.router_logits: Optional[torch.Tensor] = None
        self.router_bias: Optional[torch.Tensor] = None
        self.router_token_positions: Optional[torch.Tensor] = None
    ...
    def reset_for_retract(self):
        ...
        self.router_inputs = None
        self.router_logits = None
        self.router_bias = None
        self.router_token_positions = None
        self.last_node = None
...
class ScheduleBatch(ScheduleBatchDisaggregationDecodeMixin):
    ...
    # Whether to return router inputs and logits
    return_router_states: bool = False
    ...
    def init_new(
        ...
        return cls(
            ...
            return_router_states=any(req.return_router_states for req in reqs),
